...
<head>
  ...
  <title>
    Inventario Dashboard - Free Dashboard for Bootstrap 4 by Creative Tim
  </title>
  <!-- Favicon -->
  ...
  <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
      ...
      <a class="navbar-brand pt-0" href="./index.html">
        <img src="<?php echo e(asset('img/brand/logo.jpg')); ?>" style="width:200px;height:250px;" class="navbar-brand-img" alt="...">
      </a>
      <!-- User -->
      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <!-- Navigation -->
       <?php echo $__env->make('includes.panel.menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      </div>
    </div>
  </nav>
            ...
            <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <div class="media align-items-center">
                ...
                <div class="media-body ml-2 d-none d-lg-block">
                  <span class="mb-0 text-sm  font-weight-bold">Martin Cespedes</span>
                </div>
              </div>
            </a>
            <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-right">
...
</html><?php /**PATH C:\laragon\www\inventarioWeb2\resources\views/layouts/panel.blade.php ENDPATH**/ ?>